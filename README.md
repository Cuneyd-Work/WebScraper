...
- **Python 3** - Version relativ egal, am besten die aktuelle stabile
...
Entweder über Kommandozeile oder über IDE das Programm starten. 

1. Nachdem das Programm startet, öffnet der Chrome-Browser
2. Dort muss höchstwahrscheinlich ein Captcha gelöst werden - dies lösen
3. Danach scraped das Programm automatisch per Google Suche
4. Am Ende gibt es die `final.csv` Datei aus und schickt automatisch eine Mail
